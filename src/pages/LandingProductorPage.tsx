  ...
  return (
    <div className="landing-page min-h-screen flex flex-col">
      ...
      <main id="main" className="flex-1">
        <LandingHero 
          eyebrow="Para productores de maíz y frijol en El Salvador"
          h1="Sepa qué hacer antes de que la canícula afecte su maíz o frijol."
          subheadline="Le avisamos a tiempo y le decimos qué revisar en su parcela. Sin mapas complicados. En español claro."
