    ...
    <header className="sticky top-0 z-50 w-full border-b border-[var(--sato-color-border)] bg-white/85 backdrop-blur-md" role="banner">
      ...
      <div className="landing-container flex h-16 items-center justify-between">
        <div className="flex items-center gap-6">
          <Link to="/" className="flex items-center gap-2" aria-label="Ir al inicio de SATO-Agro">
            <div className="h-8 w-8 rounded-md bg-[var(--sato-color-primary)] flex items-center justify-center" aria-hidden="true">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm font-medium text-[var(--sato-color-text-muted)]" aria-label="Navegación principal">
            <a href="#como-funciona" className="hover:text-[var(--sato-color-text)] transition-colors">
              Cómo funciona
            </a>
            <a href="#ejemplo" className="hover:text-[var(--sato-color-text)] transition-colors">
              Ejemplo de alerta
            </a>
            <a href="#faq" className="hover:text-[var(--sato-color-text)] transition-colors">
